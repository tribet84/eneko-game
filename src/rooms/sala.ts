...
const NPCS: NPC[] = [
  {
    ...
    accepts: {
      ...
      cafe: {
        needAlso: 'usb',
        missing: 'Si le doy solo el cafe se queda mirandome la cara. Necesito el pendrive de Blanca listo en la mano para hacer el cambiazo mientras se distrae con el primer sorbo.',
        ...
        card: [
          ...
          'primer sorbo de cafe, Eneko desliza el',
          'pendrive en su ordenador. Click. El examen',
          'de suelo sedimentario se convierte en el',
          'facilito que guardaba Blanca.',
          '',
          'Manana: notable sin estudiar.',
          'Unai sonrie. Blanca disimula. Pantxo canta.',
          'Alfonso le pone un 5 por intentarlo.',
          '',
          'FIN',
          '',
